# -*- coding: utf-8 -*-
"""
Created on Fri Jul  8 23:43:41 2022
...
model=pickle.load(open('bg_model.pkl','rb'))
...
if st.button('predict'):
    #input_news = ["Pamela Geller Congress: Attorney General Lynch ‘Pleads Fifth’ on Secret Iran ‘Ransom’ Payments"]
    #df2= pd.DataFrame(input_news)
    #df2[0] =df2[0].apply(stemming)
